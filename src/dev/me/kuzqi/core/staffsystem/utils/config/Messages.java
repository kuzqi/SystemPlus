...
public enum Messages {
	...
	PLUGIN_ENABLE("plugin-copyright.plugin-start-up-msg"),
    ...
    public String from(FileConfiguration fileConfiguration) {
        String message = fileConfiguration.getString(msg);
