...
public class TextUtils {
	...
	public void sendClickableCommandMessage(Player player, String msg, String clickPart, String hover, String command) {
	...
	public void sendHelpMessage(CommandSender cs) {
		for (String msg : m.getMessagesConfig().getStringList("help")) {
        	cs.sendMessage(format(msg.toString()));
        }
	}
	
	public void sendAuthorName(CommandSender cs) {
		cs.sendMessage(Messages.PLUGIN_BY.from(m.getMessagesConfig()));
	}
