...
import dev.me.kuzqi.core.staffsystem.commands.SystemCommand;
import dev.me.kuzqi.core.staffsystem.commands.admincommands.ACWarnCommand;
...
import dev.me.kuzqi.core.staffsystem.commands.staffcommands.WarnCommand;
...
public class PluginManager {
	...
	public void loadCommands() {
		...
		m.getCommand("system").setExecutor(new SystemCommand(m));
		...
		m.getCommand("warn").setExecutor(new WarnCommand(m));
		m.getCommand("acwarn").setExecutor(new ACWarnCommand(m));
